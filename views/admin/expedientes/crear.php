...
<h2 class="content-heading d-print-none">
    <a href="/admin/expedientes" class="btn btn-alt-primary float-right">
    ...
    <div class="block-content">
        ...
        <div class="row justify-content-center py-20">
            <div class="col-xl">
                ...
                <form class="js-validation-material" id="paciente_form" method="POST" enctype="multipart/form-data" action="/admin/expedientes/crear">
