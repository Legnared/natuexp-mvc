<h2 class="content-heading d-print-none">
    <a href="/admin/system/perfil/cambiar-password" class="btn btn-alt-primary float-right">
...
<div class="block">
    <div class="block-content">
        ...
        <?php include_once __DIR__ . '/../../../template/alerta.php'; ?>
            ...
            <form class="js-validation-material" method="POST" action="/admin/system/perfil/">
