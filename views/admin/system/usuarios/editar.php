...
<h2 class="content-heading d-print-none">
    ...
    <?php echo $titulo; ?> | Gestión de Usuarios | Editar Usuario
</h2>
<div class="block">
    <div class="block-content">
        ...
        <div class="row justify-content-center py-20">
            <div class="col-xl-6">
                ...
                <form class="js-validation-material" id="usuario_form" method="POST" enctype="multipart/form-data" action="/admin/system/usuarios/editar">
