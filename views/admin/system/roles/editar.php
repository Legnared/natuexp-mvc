<div class="block">
    <div class="block-header block-header-default">
        <a href="/admin/system/roles" class="btn btn-alt-primary">
            ...
            <div class="col-xl">
                ...
                <form class="js-validation-material" id="paciente_form" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <button type="submit" name="save" id="btneditarPaciente" class="btn btn-danger mr-5 mb-5"> <i class="fa fa-edit mr-5"></i>Actualizar Rol</button>
                    </div>
                </form>
            </div>
        </div>
