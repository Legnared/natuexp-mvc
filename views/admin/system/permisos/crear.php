    ...
    <div class="block-content">
        ...
        <div class="row justify-content-center py-20">
            <div class="col-xl-6">
                ...
                <form class="js-validation-material" id="rol_form" method="POST" action="/admin/system/permisos/crear">
                    <?php include_once __DIR__ . '/formulario.php'; ?>

                    <!-- Botón de submit -->
                    <button type="submit" class="btn btn-primary mt-3">Crear Permiso</button>
                </form>
            </div>
        </div>
    </div>
