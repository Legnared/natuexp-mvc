...
<head>
    ...
    <title>Natuexp | <?php echo $title ?? '';  ?> </title>
...
<script src="/build/assets/js/plugins/jquery-validation/jquery.validate.min.js"></script>
<script src="https://cdn.jsdelivr.net/npm/sweetalert2@9"></script>
<script src="/build/assets/js/pages/op_auth_signin.js"></script>
