                    ...
                    <div class="content content-full">
                        <div class="px-30 py-10">
                            <a class="link-effect font-w700" href="/login">
                                ...
                                <span class="font-size-xl text-primary-dark">Expedientes </span><span class="font-size-xl">Clínicos</span>
                            </a>
                            <h2 class="h5 font-w400 text-muted mb-0 text-center"><?php echo $title; ?></h2>
                        </div>
                        <div class="px-30">
                                        ...
                                        <?php if (isset($alertas['success'])) { ?>
                                            <div class="mt-30">
                                                <a class="link-effect text-muted mr-10 mb-5 d-inline-block" href="/login">
                                                    <i class="fa fa-sign-in mr-5"></i> Click Aquí para Iniciar Sesión
                                                </a>
                                            </div>
                                        <?php } ?>
                                    </div>
